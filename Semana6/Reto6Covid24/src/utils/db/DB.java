...
public class DB {
    ...
    private String url = "jdbc:mysql://localhost:3306/covid24";

    private String userTest = "root";
    private String passwordTest = "";
    private String urlTestInit = "jdbc:h2:mem:test;MODE=MYSQL;INIT=RUNSCRIPT FROM 'F:/Documentos/Jesus/MisionTIC/Ciclo2/ProgramacionBasica/Retos/Semana6/Reto6Covid24/covid-test-1.sql';DB_CLOSE_DELAY=-1";
